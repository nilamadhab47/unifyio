...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground flex flex-col">
      ...
      <header className="w-full border-b border-border/40 backdrop-blur-sm bg-background/80 fixed z-10">
        <div className="container mx-auto flex justify-between items-center py-3 md:py-4 px-4 md:px-6">
          <motion.h1 
            ...
            className="text-xl md:text-2xl font-bold bg-gradient-to-r from-violet-500 via-blue-400 to-cyan-300 text-transparent bg-clip-text [text-shadow:0_0_20px_rgba(139,92,246,0.2)]"
          >
            Unifyio
          </motion.h1>
          ...
          {/* Mobile Menu Button */}
          <button 
            className="md:hidden text-foreground p-1 rounded-md focus:outline-none focus:ring-2 focus:ring-violet-500/50"
        ...
        {mobileMenuOpen && (
          ...
          >
            <nav className="container mx-auto py-4 flex flex-col space-y-4 px-4">
              <a href="#features" className="text-sm text-foreground/80 hover:text-foreground transition-colors duration-200 py-1" onClick={() => setMobileMenuOpen(false)}>Features</a>
              <a href="#modules" className="text-sm text-foreground/80 hover:text-foreground transition-colors duration-200 py-1" onClick={() => setMobileMenuOpen(false)}>Modules</a>
              <a href="#about" className="text-sm text-foreground/80 hover:text-foreground transition-colors duration-200 py-1" onClick={() => setMobileMenuOpen(false)}>About</a>
              <Dialog>
                <DialogTrigger asChild>
                  <Button variant="default" className="bg-gradient-to-r from-violet-600 to-blue-600 hover:from-violet-700 hover:to-blue-700 mt-2">
                    Join Waitlist
                  </Button>
                </DialogTrigger>
                <DialogContent className="sm:max-w-md">
      ...
      {/* Hero Section */}
      <section className="pt-24 md:pt-32 pb-16 md:pb-20 px-4 md:px-6 container mx-auto">
        <div className="max-w-4xl mx-auto text-center">
          <motion.h1 
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.7, delay: 0.2 }}
            className="text-3xl sm:text-4xl md:text-6xl font-bold mb-4 md:mb-6 bg-gradient-to-r from-violet-500 via-blue-400 to-cyan-300 text-transparent bg-clip-text [text-shadow:0_0_30px_rgba(139,92,246,0.25)]"
          >
            All Your Business Tools,<br className="hidden sm:block"/> One Seamless Platform
          </motion.h1>
          <motion.p 
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.7, delay: 0.4 }}
            className="text-lg sm:text-xl md:text-2xl text-foreground/80 mb-6 md:mb-8 px-2"
          >
      ...
      {/* Features Section */}
      <section id="features" className="py-16 md:py-20 px-4 md:px-6 bg-foreground/5">
        <div className="container mx-auto">
          <div className="text-center mb-12 md:mb-16">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-3 md:mb-4">Why Choose Unifyio?</h2>
            <p className="text-foreground/70 max-w-2xl mx-auto px-2">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 md:gap-8">
            <motion.div
              ...
              transition={{ duration: 0.5 }}
              viewport={{ once: true }}
              className="p-4 md:p-6 rounded-lg border border-border/40 bg-card/30 backdrop-blur-sm"
            >
              <h3 className="text-lg md:text-xl font-semibold mb-2 md:mb-3">Cost Efficiency</h3>
            ...
            <motion.div
              ...
              className="p-4 md:p-6 rounded-lg border border-border/40 bg-card/30 backdrop-blur-sm"
            >
              <h3 className="text-lg md:text-xl font-semibold mb-2 md:mb-3">Seamless Integration</h3>
              <p className="text-sm md:text-base text-foreground/70">
            ...
            <motion.div
              ...
              className="p-4 md:p-6 rounded-lg border border-border/40 bg-card/30 backdrop-blur-sm"
            >
              <h3 className="text-lg md:text-xl font-semibold mb-2 md:mb-3">Scalability</h3>
              <p className="text-sm md:text-base text-foreground/70">
            ...
            <motion.div
              ...
              className="p-4 md:p-6 rounded-lg border border-border/40 bg-card/30 backdrop-blur-sm"
            >
              <h3 className="text-lg md:text-xl font-semibold mb-2 md:mb-3">Future-Proof</h3>
              <p className="text-sm md:text-base text-foreground/70">
      ...
      <section id="modules" className="py-16 md:py-20 px-4 md:px-6">
        <div className="container mx-auto">
          <div className="text-center mb-12 md:mb-16">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-3 md:mb-4">Comprehensive Modules</h2>
            <p className="text-foreground/70 max-w-2xl mx-auto px-2">
                    ...
                    <ul className="space-y-1 md:space-y-2">
                      {module.features.map((feature) => (
                        <li key={feature} className="flex items-start">
                          <Check className="mr-2 h-3.5 w-3.5 md:h-4 md:w-4 text-green-500 shrink-0 mt-0.5 md:mt-1" />
      ...
      {/* Mobile App Section */}
      <section className="py-16 md:py-20 px-4 md:px-6 bg-foreground/5">
        <div className="container mx-auto">
          <div className="flex flex-col md:flex-row items-center gap-8 md:gap-12">
            <motion.div 
              ...
              className="md:w-1/2"
            >
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-4 md:mb-6 text-center md:text-left">Powerful Mobile Experience</h2>
              <p className="text-sm md:text-base text-foreground/70 mb-4 md:mb-6 text-center md:text-left">
              ...
              <ul className="space-y-2 md:space-y-3">
                <li className="flex items-start">
                  <Check className="mr-2 h-4 w-4 md:h-5 md:w-5 text-green-500 shrink-0 mt-0.5 md:mt-1" />
                  <span className="text-sm md:text-base">Geolocation-based attendance tracking</span>
                </li>
                <li className="flex items-start">
                  <Check className="mr-2 h-4 w-4 md:h-5 md:w-5 text-green-500 shrink-0 mt-0.5 md:mt-1" />
                  <span className="text-sm md:text-base">Mobile leave management and approvals</span>
                </li>
                <li className="flex items-start">
                  <Check className="mr-2 h-4 w-4 md:h-5 md:w-5 text-green-500 shrink-0 mt-0.5 md:mt-1" />
                  <span className="text-sm md:text-base">Real-time expense submission and tracking</span>
                </li>
                <li className="flex items-start">
                  <Check className="mr-2 h-4 w-4 md:h-5 md:w-5 text-green-500 shrink-0 mt-0.5 md:mt-1" />
                  <span className="text-sm md:text-base">Instant notifications and updates</span>
                </li>
              </ul>
            </motion.div>
            <motion.div 
            ...
            >
              <div className="w-56 sm:w-64 h-[400px] sm:h-[500px] rounded-3xl border-8 border-foreground/20 bg-background/50 shadow-2xl relative">
                <div className="absolute inset-2 bg-gradient-to-br from-violet-900/30 via-blue-900/20 to-cyan-900/30 rounded-2xl flex items-center justify-center">
      ...
      <section id="about" className="py-16 md:py-20 px-4 md:px-6">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <motion.p 
            ...
            transition={{ duration: 0.5, delay: 0.1 }}
            viewport={{ once: true }}
            className="text-sm md:text-lg text-foreground/70 mb-8 md:mb-10 px-2"
          >
      ...
      {/* Footer */}
      <footer className="py-8 md:py-10 px-4 md:px-6 border-t border-border/40">
        <div className="container mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="mb-6 md:mb-0 text-center md:text-left">
              <p className="text-lg md:text-xl font-bold bg-gradient-to-r from-violet-500 via-blue-400 to-cyan-300 text-transparent bg-clip-text [text-shadow:0_0_20px_rgba(139,92,246,0.2)]">
                Unifyio
              </p>
            ...
            <div className="flex flex-wrap justify-center gap-6 md:gap-8">
              <a href="#features" className="text-xs md:text-sm text-foreground/70 hover:text-foreground">Features</a>
              <a href="#modules" className="text-xs md:text-sm text-foreground/70 hover:text-foreground">Modules</a>
              <a href="#about" className="text-xs md:text-sm text-foreground/70 hover:text-foreground">About</a>
            </div>
          </div>
          <div className="mt-6 md:mt-8 pt-6 md:pt-8 border-t border-border/20 text-center text-xs md:text-sm text-foreground/60">
